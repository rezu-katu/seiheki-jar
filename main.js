...
const JAR_DESCRIPTIONS = [
  "舌や口で相手を気持ちよくする行為。距離の近さや丁寧さが好みの分かれどころ。",
  "バイブやローターなどの道具を使うプレイ。刺激の強さや使い方を一緒に調整しやすい。",
  "肌に吸いあとを残すキス。見える場所に残すかどうかは事前に確認したいポイント。",
  "服装や役になりきって雰囲気を楽しむプレイ。日常と違う自分になれるのが魅力。",
  "陰毛を処理してつるつるにした状態。見た目や触り心地の好みとして選ぶ項目。",
  "自然な毛量や濃さをそのまま楽しむ好み。手入れしすぎない質感に惹かれる人向け。",
  "いきそうな直前で止めて、期待感を高めるプレイ。焦らされる時間も含めて楽しむ。",
  "すぐに触れず、言葉や手つきでじらして気持ちを高めるプレイ。ゆっくり進むのが好きな人向け。",
  "屋外で性的なことをするシチュエーション。現実では周囲への配慮と法的リスクの確認が必須。",
  "屋外で肌や身体を見せるシチュエーション。人目や場所の扱いには慎重さが必要。",
  "同意のある相手同士で、痴漢風の状況を演じるプレイ。現実の無断行為は絶対NG。",
  "言葉で責めたり褒めたりして気持ちを高めるプレイ。言われたい言葉の範囲確認が大事。",
  "身体や肌に文字や印を書くプレイ。消える素材か、残してよい場所かを決めておくと安心。",
  "首まわりに手を添える、または圧迫感を演出するプレイ。危険が高いので安全確認が最優先。",
  "目を隠して感覚を鋭くするプレイ。見えないぶん、合図や止め方を決めておくと楽しみやすい。",
  "手足や身体の動きを制限するプレイ。ほどける方法と中止サインを先に決めておく。",
  "縄などで身体を美しく縛るプレイ。見た目や支配感を楽しむ一方で、しびれや痛みの確認が必要。",
  "お尻などを叩いて刺激を楽しむプレイ。強さや回数の好みが分かれやすい。",
  "乳首を触る、舐める、つまむなどして刺激するプレイ。強さの好みを細かく合わせやすい。",
  "お腹への打撃や圧を含むプレイ。危険があるので、現実で行う場合は無理をしない前提で。",
  "奥側の強い刺激を狙う挿入系のプレイ。身体への負担が出やすいので、痛みがあればすぐ止める。",
  "肛門まわりを刺激するプレイ。衛生面と潤滑、ゆっくり進めることが大切。",
  "同意のある相手同士で、無理やり風の状況を演じるプレイ。現実の不同意行為は絶対NG。",
  "恋人や好きな人を他の相手に取られる想像を楽しむジャンル。嫉妬や不安の扱いに注意。",
  "パートナー同士で相手を交換するプレイ。全員の同意と境界線の確認が前提。",
  "性的な場面を撮影するプレイ。保存先、共有範囲、削除ルールを必ず決めておきたい。",
  "複数人で楽しむプレイ。人数が増えるぶん、同意や役割、NGの共有が大切。",
  "尿を飲む、または飲ませるプレイ。飲ませたいは青のしたい、飲みたいは赤のされたい。衛生面や体調への配慮が必要な上級者向けの好み。",
];
...
function openSheet(index) {
  ...
  document.getElementById("sheet-description").textContent = "説明：" + JAR_DESCRIPTIONS[index];
